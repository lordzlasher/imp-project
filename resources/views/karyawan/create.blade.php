...
@endphp
@section('header-icon', 'user-plus')
@section('header-title', 'Add Karyawan')
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('jenis_bank') is-invalid @enderror" id="jenis_bank"
                                        name="jenis_bank" type="text" placeholder="Masukan jenis Bank"
                                        value="{{ old('jenis_bank') }}" />
                                    @error('jenis_bank')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('nomer_rekening') is-invalid @enderror"
                                        ...
                                        placeholder="Masukan nomer rekening" value="{{ old('nomer_rekening') }}" />
                    ...
                    <div class="card mb-4 mb-xl-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <img id="ktp_preview" class="img-account-profile mb-3" width="250"
                                src="../tamplate/assets/img/ktp_preview.jpg" />
