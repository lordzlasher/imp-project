...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('event_crews', function (Blueprint $table) {
            ...
            $table->foreignId('id_status_crew')->constrained('status_crews')->onDelete('cascade');
            $table->foreignId('id_keterangan_crew')->constrained('keterangan_crews')->onDelete('cascade');
            $table->timestamps();
        });
    }
